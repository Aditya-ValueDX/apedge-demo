...
const ApproverReports = ({ navigateTo, userRole }) => {
  ...
  // Dummy data for Approver's reports (requests they approved/rejected, or pending their approval)
  const dummyReportData = useMemo(() => [
    { id: 'RPT001', date: '2024-07-01', user: 'Alice Brown', amount: 150, approver: 'Approver', status: 'Processed', billType: 'Travel' },
    { id: 'RPT002', date: '2024-07-05', user: 'Bob White', amount: 75, approver: 'Approver', status: 'Waiting Approval', billType: 'Food' },
    { id: 'RPT003', date: '2024-07-10', user: 'Alice Brown', amount: 200, approver: 'Approver', status: 'Stage 1 Approved', billType: 'Office Supplies' },
    { id: 'RPT004', date: '2024-07-12', user: 'Charlie Green', amount: 50, approver: 'Approver', status: 'Rejected', billType: 'Travel' },
    { id: 'RPT005', date: '2024-06-20', user: 'Another Requester', amount: 120, approver: 'Approver', status: 'Processed', billType: 'Food' },
  ], []);
  ...
  const filteredReports = useMemo(() => {
    ...
    const { status, requester, billType, fromDate, toDate, globalSearch } = advancedFilters;
  ...
  return (
    <div className="card-container">
      <h2 className="section-title">Approver Reimbursement Reports</h2>
